...
**Written Communications** we evaluated model assumptions visually . for homscedasticity of residuals we used residuals vs. fitted and scale location plots. for normality of residuals, we used QQ plots . based on our diagnositcs there were no major deviations from homoscedasticity or normality or residuals ther were also no outliers that might influence model estiamtes or predictors . 
### Model summary
